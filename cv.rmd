...
I lead the Marketing Science and Analytics function alongside co-founder Eric Bradlow at GBK Collective where we apply econometric, statistical, and machine learning algorithms (usually with R) to help solve business problems. 
...
- Interface with client and project teams, execute analysis, and run the day-to-day operations of our analytics funcion. This includes exploring solutions to analytic problems, developing best practices around the implementations of those solutions, and growing and managing the analytics team.
...
- Performed marketing analytics to support strategic management consulting engagements, including conjoint analysis, maximum-difference scaling, customer segmentation, perceptual mapping, and other statistical or econometric analysis.
...
- Performed economic, financial, and statistical analysis to support professors engaged as expert witnesses in over 100 commercial litigation matters related to consumer fraud, bankruptcy, forensic accounting, asset pricing, and others.
